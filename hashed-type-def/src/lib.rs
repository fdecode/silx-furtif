...
//!   
//! `hashed-type-def` contains components and macros for deriving type hashcode to identify a type  
//! 
//! # Content
...
pub use hashed_type_def_core::{ HashedTypeDef, HashedTypeUuid, add_hash_fnv1a, start_hash_fnv1a, };
#[cfg(feature = "derive")]
